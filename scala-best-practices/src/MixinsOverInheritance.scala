object MixinsOverInheritance {
  ...
  class MyStringContainer2(val string: String) extends StringContainer2 with LowerCaseable2{
    val lowerCased = string.toLowerCase
  }

  def myFunction2(in: LowerCaseable2) = {
  ...
  def main(args: Array[String]): Unit = {
    ...
    myFunction2(new MyStringContainer2("This is a TEST"))
    myFunction3(new MyListContainer(List(1,2,3,4)))
    myFunction4(new MyLengthedContainer(List(1,2,3,4)) with Countable3)
